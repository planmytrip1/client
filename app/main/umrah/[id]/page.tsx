  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            {activeTab === 'overview' && (
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {/* Excludes */}
                  {umrah.packageExcludes && umrah.packageExcludes.length > 0 && (
                    <div>
                      <h2 className="text-xl font-semibold mb-3">Package Excludes</h2>
                      <ul className="space-y-2">
                        {umrah.packageExcludes.map((item, index) => (
                          <li key={index} className="flex items-start">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="p-4 border border-gray-200 rounded-lg">
                      ...
                      {umrah.meals.mealPlan && (
                        <p className="mb-2 text-gray-700">
                          <span className="font-medium">Meal Plan:</span> {umrah.meals.mealPlan}
                        </p>
                      )}
                      {umrah.meals.approximateCost && (
                        <p className="mb-2 text-gray-700">
                          <span className="font-medium">Approximate Cost:</span> {umrah.meals.approximateCost}
                        </p>
                      )}
                      {umrah.meals.menuOptions && umrah.meals.menuOptions.length > 0 && (
                        <div>
                ...
                {umrah.dateOptions && (
                  <div className="mt-6">
                    <h2 className="text-xl font-semibold mb-3">Travel Dates</h2>
                    <div className="p-4 border border-gray-200 rounded-lg">
                      {umrah.dateOptions.groupTravelDates.length > 0 && (
                        <div className="mb-4">
              ...
              <div>
                ...
                {umrah.flightOptions && (
                  <div className="p-4 border border-gray-200 rounded-lg">
                    ...
                    {umrah.flightOptions.airlines && umrah.flightOptions.airlines.length > 0 && (
                      <div className="mt-4">
        ...
        <div className="p-6">{umrah && umrah._id && <ReviewSection entityId={umrah._id} entityType="Umrah" />}</div>
      </div>
    </div>
  );
}