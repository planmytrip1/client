  ...
  return (
    <div className="group bg-surface rounded-2xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
      ...
      <div className="relative h-52 w-full">
        ...
        {/* Gradient Overlay */}
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-umrah/70 to-transparent p-4">
        ...
        {umrah.featured && (
          <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full shadow-md">
            <span className="text-umrah font-semibold text-sm">Featured</span>
          </div>
        )}
      </div>
      ...
      <div className="p-5 flex flex-col justify-between h-64">
        <div>
          ...
          <div className="space-y-2 mb-4">
            {umrah.flightOptions.airlines.length > 0 && (
              <div className="flex items-start">
                <Check className="h-4 w-4 text-umrah mt-1 mr-2" />
          ...
          {/* Description */}
          <p className="text-text-light text-sm line-clamp-2 mb-4">{umrah.description}</p>
        </div>
        ...
        <div>
          ...
          <div className="flex justify-between items-center mt-2 mb-4">
            <div className="">
              <span className="text-umrah font-semibold text-sm">
            ...
            <p className="flex justify-start items-center gap-1">
              <Star className="w-5 h-5 mt-[-1px] text-umrah" /> 4.5 <small>(18)</small>
            </p>
          </div>
          ...
          <Link
            ...
            className="block w-full py-2.5 px-4 bg-gradient-to-r from-umrah to-umrah-400 hover:from-umrah-600 hover:to-umrah-500 text-white text-center rounded-lg font-medium transition-all duration-300 shadow-md hover:shadow-lg"
          >
            View Details
          </Link>
        </div>
